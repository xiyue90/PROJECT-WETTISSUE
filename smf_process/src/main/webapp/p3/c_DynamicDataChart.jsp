    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        for (var i = data.length - 1; i >= 0; i--) {
          ...
          // var success = data[i].tf3 === 1 ? 600 : 0; // TF3 값이 1이면 무게를 성공 데이터로 표시
          var fail1 = data[i].error === "무게 에러 입니다." ? weight : undefined;
          var fail2 = data[i].error === "온도 에러 입니다." ? temperature : undefined;
         ...
         // successData.unshift(success); // 성공 값을 series 앞에 추가
          fail1Data.unshift(fail1);
          fail2Data.unshift(fail2);
      ...
      //  option.series[2].data = successData; // 시리즈 데이터 업데이트
        option.series[2].data = fail1Data;
        option.series[3].data = fail2Data;
